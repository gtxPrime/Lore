...
import com.gxdevs.nurtale.pets.PetCatalogRepository
import com.gxdevs.nurtale.pets.PetCatalogSyncWorker
import com.gxdevs.nurtale.pets.PetSyncGuard
import com.gxdevs.nurtale.ui.JournalViewModel
import com.gxdevs.nurtale.ui.journal.AfterJournalRecordScreen
import com.gxdevs.nurtale.ui.journal.AfterJournalViewModel
import com.gxdevs.nurtale.ui.journal.JournalDetailScreen
import com.gxdevs.nurtale.ui.journal.TextJournalScreen
import com.gxdevs.nurtale.ui.lock.PinLockScreen
import com.gxdevs.nurtale.ui.pets.PetViewModel
import com.gxdevs.nurtale.ui.profile.IdentityScreen
import com.gxdevs.nurtale.ui.stats.StatsScreen
import com.gxdevs.nurtale.ui.theme.MyApplicationTheme
import com.gxdevs.nurtale.utils.cancelDailyReminder
import com.gxdevs.nurtale.utils.createNotificationChannels
import com.gxdevs.nurtale.utils.MediaEncryptionManager
import com.gxdevs.nurtale.utils.scheduleDailyReminder
                ...
                LaunchedEffect(isUnlocked, securitySettingsState, authAttempted, biometricAvailable) {
                    ...
                    when {
                        ...
                        biometricAvailable && useBiometric -> {
                            authAttempted = true
                            com.gxdevs.nurtale.utils.SecurityManager(this@MainActivity)
                                .authenticate(
                                ...
                                NavHost(
                                    ...
                                    composable(
                                        ...
                                        CompositionLocalProvider(LocalNavAnimatedVisibilityScope provides this) {
                                            com.gxdevs.nurtale.ui.home.HomeScreen(
                                    ...
                                    composable("settings") {
                                        com.gxdevs.nurtale.ui.settings.SettingsScreen(
                                        )
                                    }
                                    composable("profile") {
                                        IdentityScreen(
